        ...
        <header className="lg:flex block justify-between lg:py-3 py-2 lg:px-8 max-lg:space-y-2">
          <div className="space-y-2">
            <nav className="flex flex-wrap items-center gap-2 text-sm text-muted font-semibold">
              <span className="hover:font-semibold hover:text-link cursor-pointer">Locations</span>
              <span className="text-slate-300"><ChevronRight size={16} /></span>
              <span className="hover:font-semibold hover:text-link cursor-pointer">{locationDetails.state}</span>
              <span className="text-slate-300"><ChevronRight size={16} /></span>
              <span className="hover:font-semibold hover:text-link cursor-pointer">{locationDetails.city}</span>
            </nav>
